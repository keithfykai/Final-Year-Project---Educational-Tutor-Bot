      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto bg-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="rounded-2xl bg-gradient-to-br from-gray-800/30 to-black/50 border border-gray-700/50">
          ...
          <Card className="mt-12 rounded-2xl bg-gradient-to-br from-gray-800/30 to-black/50 border border-gray-700/50">
            <CardBody className="p-8">
              <h3 className="text-2xl font-bold text-white mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gray-900/60 border border-gray-700/50 p-6 rounded-xl hover:border-gray-500 hover:bg-gray-800/60 transition-all duration-300">
